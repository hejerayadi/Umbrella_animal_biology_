...
from backend.agents.Protein_visualization.app.knowledge_base.schemas import DocumentType, KnowledgeDocument
from backend.agents.Protein_visualization.app.tools import InterProClient, UniProtClient
