...
if __name__ == "__main__":
    ...
    async def _run_task1_tests():
        ...
        assert result["species"]["assembly_id"] is not None
        assert result["species"]["scientific_name"] is not None
    ...
    async def _run_task3_tests():
        ...
        # Test 8: Partial failure — annotation empty but metadata may be present
        print(sep)
