...
class Candidate:
    ...
    #: How decisively the references voted, averaged over the gap's columns:
    #: the winner's margin over the runner-up, so 0 is an even split and 1
    #: is unanimous. Deliberately not the winner's raw share - that scores
    #: a near-tie at 0.6 and reads far more confident than it is.
